...
import { telephoneRegex, emailRegex, zipCodeRegex } from "../regexPatterns";
...
export const businessContactSchema = z.object({
    ...
    zipCode: z.string().min(1, "Postal code is required").regex(zipCodeRegex, "Invalid postal code format")
  })
